...
export default function TeamMemberModal({ isOpen, onClose, onSuccess, teamId, member }: TeamMemberModalProps) {
  ...
  const loadUsers = async () => {
    ...
    try {
      const availableUsers = await userService.getUsersNotInTeam(teamId)
            ...
            <div className="space-y-3">
              <label className="flex items-center space-x-3 p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">Can view and manage their own tasks</p>
                  </div>
                </div>
              </label>
              ...
              <label className="flex items-center space-x-3 p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-900">Leader</p>
                    <p className="text-xs text-gray-500">Can manage team members and view team overview</p>
                  </div>
                </div>
              </label>
            </div>
